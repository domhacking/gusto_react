    ...
    render: function() {
        ...
        return (
            React.createElement("div", null, 
                React.createElement("ul", null, categories.map(function(m, index){
                    ...
                    return React.createElement("li", {key: index, className: style, onClick: self.clicked.bind(self, index)}, m.title);
                }))
            )
        )
    }
...
var Cupboard = React.createClass({displayName: "Cupboard",
    ...
    render: function(){
        ...
        return(
            React.createElement("div", null, 
                React.createElement("div", {className: "cupboard"}, 
                    React.createElement("div", {className: "catergories--container"}, 
                        React.createElement("h2", {className: "catergories--header"}, "Store Cuboard"), 
                        React.createElement(Categories, {categories: this.state.categoriesData, 
                                    selectCategory: this.selectCategory}), 
                        React.createElement(Products, {productSearchItems: this.state.productsData, 
...
ReactDOM.render(React.createElement(Cupboard, null), document.getElementById('app'));

module.exports = Cupboard;

},{"./Categories":1,"./Products":3,"react":160,"react-dom":31}],3:[function(require,module,exports){
var React = require('react');
var ReactDOM = require('react-dom')
...
var Products = React.createClass({displayName: "Products",
    ...
    render: function() {
        ...
        return (
            React.createElement("div", null, 
                React.createElement("input", {type: "text", value: this.state.searchString, onChange: this.handleChange, placeholder: "Search Products"}), 

                React.createElement("ul", null, 
                    products.map(function(l, index){
                        if(chosenProducts == products[index].categories[0].title){
                            return React.createElement("li", {key: index, onClick: self.productClicked.bind(self, index)}, l.title)
                        }
                        React.createElement("p", null, "DESCRIPTION: ", this.state.productDescription)
                    }) 
                )
            )
        )
...
},{"react":160,"react-dom":31}],4:[function(require,module,exports){
(function (process){
/**
